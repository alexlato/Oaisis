...
- Express.js server connection to MongoDB cloud
- Card component in React that holds each individual AI image created
- Loader component in React that loads Cards image's from the database
